...
import { onSearchSellerFullPullGenerator } from "./generator";

export class MockOnSearchSellerFullPullClass extends MockAction {
    ...
    generator(existingPayload: any, sessionData: SessionData): Promise<any> {
        return onSearchSellerFullPullGenerator(existingPayload, sessionData);
    }
